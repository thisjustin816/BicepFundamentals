...
// Resource names
var appServiceAppName = 'toywebsite${resourceNameSuffix}'
var appServicePlanName = 'appServicePlan'
var sqlServerName = 'toysqlserver${resourceNameSuffix}'
var sqlDatabaseName = 'ToyCompanyWebsite'
var managedIdentityName = 'site'
...
resource sqlServer 'Microsoft.Sql/servers@2019-06-01-preview' = {
  ...
  resource sqlFirewallRuleAllowAllAzureIPs  'firewallRules@2014-04-01' = {
...
resource appInsights 'Microsoft.Insights/components@2018-05-01-preview' = {
  ...
  location: (location != 'westus3') ? location : 'eastus'
  tags: tags
  kind: 'web'
  properties: {
...
resource managedIdentityRollAssignment 'Microsoft.Authorization/roleAssignments@2020-04-01-preview' = {
